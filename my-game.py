...
prizeXPosition = random.randint(0, screen_width - enemy_width)
...
enemyXPosition1 =  random.randint(0, screen_width - enemy_width)
enemyYPosition1 =  screen_height

enemyXPosition2 =  random.randint(0, screen_width - enemy_width)
enemyYPosition2 =   0 - enemy_height
...
while 1: # This is a looping structure that will loop the indented code until you tell it to stop(in the event where you exit the program by quitting). In Python the int 1 has the boolean value of 'true'. In fact numbers greater than 0 also do. 0 on the other hand has a boolean value of false. You can test this out with the bool(...) function to see what boolean value types have. You will learn more about while loop structers later. 
    ...
    screen.blit(enemy, (int(enemyXPosition), int(enemyYPosition)))
    screen.blit(enemy1, (int(enemyXPosition1), int(enemyYPosition1)))
    screen.blit(enemy2, (int(enemyXPosition2), int(enemyYPosition2)))
    ...
    if playerBox.colliderect(prizeBox):
        ...
        print("You Win, you got the prize object!")

        pygame.quit()
        exit(0)

    if enemyXPosition < 0 - enemy_width and enemyYPosition1 < 0 - enemy_height and enemyYPosition2 > screen_height + enemy_height:
